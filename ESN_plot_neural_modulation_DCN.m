...
function ESN_plot_neural_modulation_DCN(num_data_set, params)
if nargin < 1
    num_data_set = 1;
    params.manual = 1;
    params.auto = 1;
...
plot_handle_(3) = subplot(2,2,[3 4]);
hold on
...
inds_span_cue_present    = ((-300+1) : 1 : (300))';
inds_span_primSac_onset  = ((-300+1) : 1 : (300))';
inds_span_primSac_vmax   = ((-300+1) : 1 : (300))';
inds_span_primSac_offset = ((-300+1) : 1 : (300))';
inds_span_corrSac_onset  = ((-300+1) : 1 : (300))';
inds_span_corrSac_vmax   = ((-300+1) : 1 : (300))';
inds_span_corrSac_offset = ((-300+1) : 1 : (300))';
...
if contains(xlabel_text_CS_probab_, '+200')
    range_inds_probability = 301:400;
elseif contains(xlabel_text_CS_probab_, '-200')
    range_inds_probability = 101:300;
end
prob_000  = sum( sum(train_data_logic_CS_000(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_000, 1);
prob_045  = sum( sum(train_data_logic_CS_045(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_045, 1);
prob_090  = sum( sum(train_data_logic_CS_090(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_090, 1);
prob_135  = sum( sum(train_data_logic_CS_135(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_135, 1);
prob_180  = sum( sum(train_data_logic_CS_180(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_180, 1);
prob_225  = sum( sum(train_data_logic_CS_225(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_225, 1);
prob_270  = sum( sum(train_data_logic_CS_270(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_270, 1);
prob_315  = sum( sum(train_data_logic_CS_315(:,range_inds_probability) ,2) > 0 ) / size(train_data_logic_CS_315, 1);
