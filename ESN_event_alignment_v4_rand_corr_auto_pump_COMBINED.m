function ESN_event_alignment_v4_rand_corr_auto_pump_COMBINED
%% clear
clear;
...
clearvars -except EPHYS BEHAVE
fprintf(['Building BEHAVE Alignment events', ' ... ']);
time_reference      = BEHAVE.time_1K(1) : 0.01 : BEHAVE.time_1K(end);
