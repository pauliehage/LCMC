...
extract_population_data(path_data_monkey_sorted,cell_type);
...
% build_neural_properties(); % load cell_data files (_combine_) and form properties data.
...
function extract_population_data(path_data_monkey_sorted,cell_type_in)
...
%             recs_cson{counter_recs} = rec_meta_data.csOn;
        ...
        for counter_cell = 1:n_cells
            ...
            ind = find(bndls_ == cell_bndl(counter_cell),1);
            ...
            load([sess_path 'units' filesep current_cell filesep...
                ...
                'Neural_Properties','SACS_ALL_DATA','id');
            Neural_Properties.type = cell_type_in;
            cs_cell_name = [sess_name '_*_'...
                num2str(cell_cson,'%.3i') '_combine_*'];
            cs_on_file = dir([sess_path 'units' filesep...
                cs_cell_name filesep cs_cell_name '.mat']);
            load([cs_on_file(1).folder filesep ...
                cs_on_file(1).name],'CS_on_data');
            ...
            save([out_path unit_file],'EXPERIMENT_PARAMS','id',...
                'Neural_Properties','SACS_ALL_DATA','CS_on_data');
...
ESN_global_variables(flag_pair_list);
global event_type_list amp_edges vel_edges ang_edges length_trace tag_name_list
