...
for counter_tag = 1 : 9
    ...
    elseif counter_tag > 5 && counter_tag < 8
        idx_tag = (LICKS_ALL_DATA.tag_bout==(counter_tag - 5));
        title_ = params.lick.tag_bout_name_list{(counter_tag - 5)};
    elseif counter_tag >= 8
        idx_tag = (LICKS_ALL_DATA.tag_harvest==(counter_tag - 7));
        title_ = params.lick.tag_harvest_name_list{(counter_tag - 7)};
    end
